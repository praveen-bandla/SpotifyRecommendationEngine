...
![](https://github.com/praveen-bandla/SpotifyRecommendationEngine/assets/114946455/053e4c79-2df4-4651-8c3c-3000289b8cd7)
...
<img width="730" alt="Snapshot of the Training Evaluation" src="https://github.com/praveen-bandla/SpotifyRecommendationEngine/assets/114946455/a7c2f430-f8c4-459b-82a2-d50cded16ca5">
...
1. Usage of song features: This project did not take into account any features listed in the metadata, or use the song/artist/playlist name, or playlist followers. In future works, these could be incorporated for an in-depth learning algorithm.
<br>
<br>
2. Interactive recommender: using this model, a web interface could be developed to show the predictions in real time. This would give another insight into the model’s performance. 
<br>
<br>
3. Negative edge sampling methods: As mentioned earlier, there could be alternative negative edge sampling methods explored with their implications on training and quality of recommendations studied as well.
<br>
<br>
4. Dynamic music database: While the inductive learning algorithm and bipartite graph ensure that playlists can be added efficiently and effectively without having to restart training, a continuation of the process could be implemented to extract new data, resample training splits, and resume training. 
